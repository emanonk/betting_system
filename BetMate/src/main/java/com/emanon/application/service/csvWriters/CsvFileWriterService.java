package com.emanon.application.service.csvWriters;
...
public class CsvFileWriterService {
	...
	public static void writeCsvFile(String fileName,List<Object> hi, String clazzName) {
...
//
//		} catch (Exception e) {
//			System.out.println("Error in CsvFileWriterService !!!");
//			e.printStackTrace();
//		} finally {
//
//			try {
